      ...
      const processBatch = async (startIndex: number) => {
        ...
        await Promise.all(batch.map(async (record) => {
          try {
            ...
            // FIX 1: Enforce matching programme casing so database logs align identically with activeProgram constraints
            const resolvedProg = activeProgram;
            ...
            const recordData = {
              ...
              phone: record.phone, 
              programme: resolvedProg, // Fixed: Force write to exact activeProgram casing
